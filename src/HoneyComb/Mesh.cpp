...
void MeshResource::splitStringWhitespace(std::string& input, std::vector<std::string>& output)
{
	std::string curr;
...
void MeshResource::splitString(std::string& input, char splitter, std::vector<std::string>& output)
{
	std::string curr;
...
void MeshResource::onLoad(std::string path)
{
...
void MeshResource::setBuffer(std::string attribute, VertexBuffer *buffer)
{
